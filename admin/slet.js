...
//    if(!message.channels.cache.get(`842471936952631336`)) return message.channel.send("Du kan ikke fjerne besker fra denne kanal").then(msg => msg.delete({ timeout: 10000 }))
//    
